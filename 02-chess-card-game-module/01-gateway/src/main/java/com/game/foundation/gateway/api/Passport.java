...
import com.game.foundation.gateway.DomainConstants;
...
public class Passport {
    ...
    public ResponseHandler connect(ChannelHandlerContext ctx, String token) {
        ...
        return DefaultResponseHandler.newHandler(DomainConstants.DOMAIN_GATE_WAY, MessageProvider.newMessage(OpCodeConstants.PASSPORT_CONNECT));
    }
